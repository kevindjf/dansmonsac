...
class _SharePageState extends ConsumerState<SharePage> {
            ...
            child: Column(
              ...
              children: [
                ...
                if (state.isLoading) ...[
                  ...
                  FilledButton.icon(
                    onPressed:
                        state.isSyncing ? null : () => _shareLink(state.code!),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildStatItem(
                  Icons.book, '${state.courseCount} cours', accentColor),
              const SizedBox(width: 16),
              _buildStatItem(Icons.calendar_today,
                  '${state.calendarCount} seances', accentColor),
              const SizedBox(width: 16),
              _buildStatItem(Icons.backpack, '${state.supplyCount} fournitures',
                  accentColor),
            ],
          ),
        ],
  ...
  Future<void> _shareLink(String code) async {
    ...
    final success =
        await ref.read(shareControllerProvider.notifier).syncAndShare();
...
1. Télécharge DansMonSac :
   Android : https://play.google.com/store/apps/details?id=fr.kappsmobile.dansmonsac
   iPhone : https://apps.apple.com/us/app/dansmonsac/id6758634498
